...
public class Bridal_Makeup extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bridal_makeup);
...
//            Intent i = new Intent(MainActivity2.this, home.class);
        ...
        button_1.setOnClickListener(view -> {
            Intent i=new Intent(Bridal_Makeup.this,Gallery.class);
            startActivity(i);
        });
        ...
        homeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Bridal_Makeup.this, home.class);
